...
- `Recipe`
  - `id`, `groupId`, `name`, `sourceName`, `sourceUrl`, `originKind`, `shortNote`, `instructions`, `createdAt`, `updatedAt`, `ingredients`
- `Ingredient`
...
Response: `Recipe` response with `sourceName`, `sourceUrl`, `originKind`, `shortNote`, `instructions`, `createdAt`, `updatedAt`, and ingredients.  
Status: 200 OK.  
...
Response: updated `Recipe` response including `sourceName`, `sourceUrl`, `originKind`, `shortNote`, `instructions`, `createdAt`, `updatedAt`, and ingredients.  
Status: 200 OK.  
